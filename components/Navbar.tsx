        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-24">
            ...
            <div className="hidden lg:flex items-center space-x-10">
              ...
              <div className="flex items-center space-x-3">
                <a
                  ...
                  className={`flex items-center justify-center p-1.5 rounded-md transition-all duration-300 border backdrop-blur-sm ${
                    !isScrolled
            ...
            <div className="lg:hidden flex items-center space-x-2">
              <a
                href="tel:+905458259495"
                className={`p-1.5 rounded-md transition-all duration-300 border backdrop-blur-sm ${
                  !isScrolled
                    ? 'text-stone-900 hover:text-stone-700 border-white/30 bg-white/20 hover:bg-white/30 shadow-md'
                    : 'text-stone-700 hover:text-stone-900 border-stone-200 bg-white/90 hover:bg-white shadow-sm'
                }`}
