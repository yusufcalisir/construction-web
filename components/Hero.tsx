      ...
      <div className="max-w-6xl mx-auto text-center relative z-[2] -mt-16 sm:-mt-12 lg:mt-0">
        ...
        <div className="flex justify-center items-center">
          <a
            ...
            className="group relative px-12 py-5 rounded-full transition-all duration-300 font-semibold text-base tracking-wide overflow-hidden flex items-center gap-3 bg-green-500 text-white hover:bg-green-600 hover:shadow-2xl hover:shadow-green-500/30"
          >
