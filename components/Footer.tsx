            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3">
                <a
                  ...
                  className="inline-flex items-center justify-center w-12 h-12 rounded-full transition-[background-color] duration-300 bg-green-500 text-white hover:bg-green-600"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center justify-center w-12 h-12 rounded-full transition-opacity duration-300 bg-gradient-to-r from-purple-500 via-pink-500 to-orange-500 text-white hover:opacity-90 will-change-opacity"
                >
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
