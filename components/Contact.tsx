    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Phone */}
          <div className={`rounded-2xl p-8 border-2 transition-[shadow,border-color] duration-300 hover:shadow-xl ${
            theme === 'dark'
            ...
            <a
              ...
              className={`text-2xl font-bold transition-colors duration-300 inline-block focus:outline-none ${
                theme === 'dark'
