...
export const metadata: Metadata = {
  ...
  description: 'Ber Tadilat - İstanbul\'da ev, iş yeri ve her türlü mekân için profesyonel tadilat, dekorasyon, restorasyon, boya badana, alçıpan, fayans, mutfak, parke, ısı-ses yalıtımı ve dış cephe hizmetleri. 7/24 hizmet, ücretsiz keşif. ☎ 0545 825 94 95',
  keywords: [
    'ber tadilat',
  ...
  openGraph: {
    ...
    description: 'İstanbul\'da ev, iş yeri ve her türlü mekân için profesyonel tadilat hizmetleri. Dekorasyon, boya badana, alçıpan, fayans, parke ve daha fazlası. 7/24 hizmet, ücretsiz keşif!',
    images: [
      {
  ...
  twitter: {
    ...
    description: 'İstanbul\'da profesyonel tadilat, dekorasyon ve renovasyon hizmetleri. Ücretsiz keşif için hemen arayın! 7/24 hizmet.',
...
const localBusinessSchema = {
  ...
  '@id': `${baseUrl}#business`,
  name: 'Ber Tadilat',
  alternateName: ['Ber Tadilat Dekorasyon', 'Ber Tadilat İstanbul'],
  description: 'İstanbul\'da ev, iş yeri ve her türlü mekân için profesyonel tadilat, dekorasyon ve renovasyon hizmetleri. 7/24 hizmet, ücretsiz keşif.',
  url: baseUrl,
